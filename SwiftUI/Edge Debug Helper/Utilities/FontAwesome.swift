...
enum NavigationIcon {
    ...
    static let syncLight: WeightedFAIcon = WeightedFAIcon(.icon_f2f1, weight: .light)  // fa-rotate (Light 300)
}
...
enum ActionIcon {
    ...
    // Light weight variants
    static let circleXmarkLight: WeightedFAIcon = WeightedFAIcon(.icon_f057, weight: .light)  // fa-circle-xmark (Light 300)
}
...
enum DataIcon {
    ...
    // Weight variants
    static let databaseRegular: WeightedFAIcon = WeightedFAIcon(.icon_f1c0, weight: .regular)  // fa-database (Regular 400)
    static let databaseThin: WeightedFAIcon = WeightedFAIcon(.icon_f1c0, weight: .thin)        // fa-database (Thin 100)
}
