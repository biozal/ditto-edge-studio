...
namespace EdgeStudio.Shared.Models
{
    public partial class SubscriptionFormModel : ObservableObject
    {
        ...
        /// <summary>
        /// The ID of the subscription being edited, or null for new subscriptions
        /// </summary>
        ...
        /// </summary>
        /// <returns>New DittoDatabaseSubscription with generated ID, or existing ID if editing</returns>
