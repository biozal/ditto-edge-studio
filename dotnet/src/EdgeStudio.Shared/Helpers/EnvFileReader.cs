...
namespace EdgeStudio.Shared.Helpers
{
    public static class EnvFileReader
    {
        public static Dictionary<string, string> Read(Assembly? assembly = null)
        {
            assembly ??= Assembly.GetCallingAssembly();
            var envVars = new Dictionary<string, string>();

            // Read from embedded resource
            // file name is .env, this is the Default namespace + filename
